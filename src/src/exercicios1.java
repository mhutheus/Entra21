...
public class exercicios1 {
    ...
    static void exercicio13a() {
        ...
        if (s < 0) {
            ...
            System.out.println(
                    "Você pagará 10% em imposto de renda (" + (s * 0.1) + ") e seu salário será de: " + (s * 0.9));
        } else if (s <= 50000) {
            System.out.println(
                    "Você pagará 25% em imposto de renda (" + (s * 0.25) + ") e seu salário será de: " + (s * 0.75));
        } else {
            System.out.println(
                    "Você pagará 50% em imposto de renda (" + (s * 0.5) + ") e seu salário será de: " + (s * 0.5));
        }
        entrada.close();
    }
    ...
    static void exercicio17a() {
        ...
        System.out.println("Digite seu salário");
        float s = entrada.nextFloat();
        System.out.println("Digite o empréstimo que deseja receber");
    ...
    static void exercicio19a(){
        ...
        if(imc<0){
            ...
            System.out.println("Seu IMC é de magreza, sendo: "+imc);
        }
        else if(imc<25){
            System.out.println("Seu IMC é normal, sendo: "+imc);
        }
        else if(imc<30){
            System.out.println("Seu IMC é de sobrepeso, sendo: "+imc);
        }
        else if(imc<35){
            System.out.println("Seu IMC é de obesidade grau I, sendo: "+imc);
        }
        else if(imc<40){
            System.out.println("Seu IMC é de obesidade grau II, sendo: "+imc);
        }
        else{
            System.out.println("Seu IMC é de obesidade grau III, sendo: "+imc);
        }
        entrada.close();

    }

    static void exercicio20a(){
        Scanner entrada = new Scanner(System.in);
        String senha = "senha1234";
        String tentativa = "";
        int x = 0;
        for(int i = 3; i>0;){
            System.out.println("Digite sua senha ("+i+" tentativas restantes): ");
